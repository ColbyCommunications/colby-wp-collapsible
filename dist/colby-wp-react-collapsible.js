...
var _reactCollapsible = __webpack_require__(3);
...
var _collapsibleModule = __webpack_require__(5);

var _collapsibleModule2 = _interopRequireDefault(_collapsibleModule);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var renderCollapsible = function renderCollapsible() {
  Array.prototype.forEach.call(document.querySelectorAll('[data-collapsible]'), function (container) {
    var trigger = container.getAttribute('data-trigger');
    if (trigger) {
      _reactDom2.default.render(_react2.default.createElement(
        _reactCollapsible2.default,
        {
          className: _collapsibleModule2.default.Collapsible,
          openedClassName: _collapsibleModule2.default.open,
          triggerClassName: _collapsibleModule2.default.trigger,
          triggerOpenedClassName: _collapsibleModule2.default.trigger,
          contentInnerClassName: _collapsibleModule2.default.contentInner,
          transitionTime: 300,
          trigger: _react2.default.createElement(
            ...
            _react2.default.createElement(_downArrow2.default, null)
          )
        },
        _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: container.innerHTML } })
      ), container);
    }
  });
}; /* eslint react/no-danger: 0 */

exports.default = renderCollapsible;
...
var Collapsible = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement('div', { className: this.props.classParentString + ' ' + (this.state.isClosed ? this.props.className : this.props.openedClassName) }, _react2.default.createElement('span', { className: triggerClassName.trim(), onClick: this.handleTriggerClick }, trigger), this.renderNonClickableTriggerElement(), _react2.default.createElement('div', { className: this.props.classParentString + "__contentOuter" + ' ' + this.props.contentOuterClassName, ref: 'outer', style: dropdownStyle }, _react2.default.createElement('div', { className: this.props.classParentString + "__contentInner" + ' ' + this.props.contentInnerClassName, ref: 'inner' }, children)));
  }
});
...
var _renderCollapsible = __webpack_require__(1);

var _renderCollapsible2 = _interopRequireDefault(_renderCollapsible);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.addEventListener('load', _renderCollapsible2.default);
...
module.exports = {"trigger":"trigger","open":"open","contentInner":"contentInner"};
